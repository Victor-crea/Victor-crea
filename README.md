...
<p align="center">
Estudiante de Ingeniería en Sistemas Computacionales @ Universidad La Salle Bajío (León, Guanajuato, México)
<br>
Full-stack developer · Backend APIs · Cloud deployment
</p>
...
**[PetsRadar](#)** — API backend de rastreo de mascotas
Construida con NestJS, PostgreSQL 15 y Redis. Desplegada en AWS EC2, con configuración de seguridad y autenticación a nivel de base de datos.

**[Carnicería Evelia](#)** — App web para negocio familiar
